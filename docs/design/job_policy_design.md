...
| **Version**      | 1.0                                                                   |
| **Date**         | 2026-04-07                                                            |
| **Author**       | Dell Technologies Ansible Engineering Team                            |
| **JIRA Story**   | ECS02C-982 - "As an Ansible user, I want to manage PowerScale job impact policies via a declarative module" |
