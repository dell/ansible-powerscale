        ...
        for key in list(input_ads):
            if key.lower() == "groupnet":
                if input_ads[key] and \
                    ...
                    self.module.fail_json(msg="Modification of groupnet"
                                          " is not supported.")
                del input_ads[key]
            elif not input_ads[key] or \
                    input_ads[key] == array_ads[0][key]:
                del input_ads[key]
    ...
    def perform_module_operation(self):
        ...
        if state == "present" and ads_details and ads_parameters:
            ...
            if modified_ads:
                ...
                changed = self.update(ads_name[0], modified_ads, domain, instance)
...
def get_powerscale_ads_parameters():
    """
