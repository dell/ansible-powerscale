...
DOCUMENTATION = r'''
---
module: dellemc_powerscale_subnet
  ...
  subnet_params:
    ...
    suboptions:
      ...
      sc_service_addrs_state:
        description: Specifies if the sc_service_addrs range need to be added or
...
class PowerScaleSubnet(object):
    ...
    def get_powerscale_subnet_parameters(self):
        return dict(
