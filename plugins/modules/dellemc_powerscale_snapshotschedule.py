...
DOCUMENTATION = r'''
---
module: dellemc_powerscale_snapshotschedule
version_added: '1.2.0'
...
LOG = utils.get_logger('dellemc_powerscale_snapshotschedule',
                       log_devel=logging.INFO)


class PowerScaleSnapshotSchedule(object):
    ...
    def __init__(self):
        ...
        self.module_params.update(get_powerscale_snapshotschedule_parameters())
...
def get_powerscale_snapshotschedule_parameters():
...
def main():
    ...
    obj = PowerScaleSnapshotSchedule()
