...
DOCUMENTATION = r'''
---
module: dellemc_powerscale_smartquota
...
class PowerScaleSmartQuota(object):
    ...
    def perform_module_operation(self):
        ...
        VALIDATE_THRESHOLD = utils.validateThresholdOverheadParameter(
...
def get_powerscale_smartquota_parameters():
