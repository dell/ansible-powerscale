...
DOCUMENTATION = r'''
---
module: dellemc_powerscale_synciqrules

version_added: "1.3.0"

short_description: Manage SyncIQ performance rules on PowerScale
description:
...
def get_powerscale_synciqrules_parameters():
