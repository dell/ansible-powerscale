...
DOCUMENTATION = r'''
---
module: dellemc_powerscale_synciqreports
...
LOG = utils.get_logger('dellemc_powerscale_synciqreports')


class PowerScaleSyncIQReports(object):
    ...
    def __init__(self):
        ...
        self.module_params.update(get_powerscale_synciq_reports_parameters())
...
def get_powerscale_synciq_reports_parameters():
