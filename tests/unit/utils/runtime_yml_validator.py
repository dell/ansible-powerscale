...
def validate_action_group_structure(runtime_yml_dict: Dict) -> Tuple[bool, str]:
    ...
    Returns:
        Tuple of (is_valid, error_message)
    """
    if 'action_groups' not in runtime_yml_dict:
        return False, "Missing action_groups section"

    action_groups = runtime_yml_dict['action_groups']
...
def validate_module_list_completeness(
    ...
    try:
        ...
        action_group = runtime_yml_dict['action_groups']['dellemc.powerscale.all']
