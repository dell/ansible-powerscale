...
class TestRuntimeYmlHasActionGroups:
    ...
    def test_plugin_routing_has_action_groups(self, runtime_yml):
        """runtime.yml must contain action_groups key."""
        assert "action_groups" in runtime_yml, (
            "meta/runtime.yml is missing action_groups. "
...
class TestAllModulesInActionGroup:
    ...
    def test_all_actual_modules_in_action_group(self, runtime_yml, actual_module_names):
        ...
        assert not missing, (
            "The following modules are in plugins/modules/ but missing from the action group:\n"
    ...
    def test_no_extra_modules_in_action_group(self, runtime_yml, actual_module_names):
        ...
        assert not extra, (
            "The following modules are listed in action group but don't exist:\n"
