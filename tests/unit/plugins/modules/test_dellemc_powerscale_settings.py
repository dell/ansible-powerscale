...
from ansible_collections.dellemc.powerscale.plugins.modules.dellemc_powerscale_settings import PowerScaleSettings
...
class TestPowerScaleSettings():
    ...
    def setting_module_mock(self, mocker):
        ...
        setting_module_mock = PowerScaleSettings()
