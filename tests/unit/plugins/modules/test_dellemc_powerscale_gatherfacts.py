...
from ansible_collections.dellemc.powerscale.tests.unit.plugins.module_utils.mock_gatherfacts_api \
...
from ansible_collections.dellemc.powerscale.plugins.modules.dellemc_powerscale_gatherfacts import PowerScaleGatherFacts


class TestPowerScaleGatherFacts():
    ...
    def gatherfacts_module_mock(self, mocker):
        ...
        gatherfacts_module_mock = PowerScaleGatherFacts()
