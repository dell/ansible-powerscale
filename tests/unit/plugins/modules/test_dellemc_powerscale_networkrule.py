...
from ansible_collections.dellemc.powerscale.plugins.modules.dellemc_powerscale_networkrule import PowerScaleNetworkRule
...
class TestPowerScaleNetworkRule():
    ...
    def network_module_mock(self, mocker):
        ...
        network_module_mock = PowerScaleNetworkRule()
