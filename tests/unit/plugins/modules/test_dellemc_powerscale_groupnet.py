...
from ansible_collections.dellemc.powerscale.plugins.modules.dellemc_powerscale_groupnet import PowerScaleGroupnet
...
class TestPowerScaleGroupnet():
    ...
    def groupnet_module_mock(self, mocker):
        ...
        groupnet_module_mock = PowerScaleGroupnet()
    ...
    def test_invalid_groupnet_nameLen(self, groupnet_module_mock):
