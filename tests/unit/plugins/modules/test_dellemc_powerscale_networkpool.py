...
from ansible_collections.dellemc.powerscale.plugins.modules.dellemc_powerscale_networkpool import PowerScaleNetworkPool
...
class TestPowerScaleNetworkPool():
    ...
    def network_pool_module_mock(self, mocker):
        ...
        networkpool_module_mock = PowerScaleNetworkPool()
